...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="wecker" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>alarm clock</b></h1>
  ...
  <div class="w3-container" id="wecker_stellen" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>set alarm clock</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">	
  </div>
  
  <div class="w3-container w3-center" style="color:blue">
    <H3><b><form id="myForm_add" method="post" action="./wecker/stellen_form.php">
	  <input type="time" id="zeit" name="zeit" required><br><br>
	  <input class="w3-check" id="Mo" type="checkbox" name="Mo" value="1">Mon
	  <input class="w3-check" id="Di" type="checkbox" name="Di" value="2">Tue
	  <input class="w3-check" id="Mi" type="checkbox" name="Mi" value="3">Wed
	  <input class="w3-check" id="Do" type="checkbox" name="Do" value="4">Thu
	  <input class="w3-check" id="Fr" type="checkbox" name="Fr" value="5">Fri
	  <br>
	  <input class="w3-check" id="Sa" type="checkbox" name="Sa" value="6">Sat
	  <input class="w3-check" id="So" type="checkbox" name="So" value="7">Sun
	  <br><br>
...
function alert_del(myForm_del) {
  if (confirm("The alarm be deleted!")) {
